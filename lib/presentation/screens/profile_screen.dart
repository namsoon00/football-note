        ...
        appBar: AppBar(
          ...
          actions: [
            AppBarActionButton.label(
              ...
              tooltip: l10n.profileTestsActionLabel,
              icon: const Icon(Icons.psychology_alt_outlined),
              label: l10n.profileTestsActionLabel,
              maxLabelWidth: 104,
            ),
          ],
        ),
...
class _ProfileLevelHeroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rewardSummary = claimableRewards.isNotEmpty
        ? l10n.profileRewardReadySummary(claimableRewards.length)
        : nextReward == null
            ? l10n.profileNoNextReward
            : nextReward.isAvailable
                ? l10n.profileRewardNow(nextReward.customRewardName)
                : l10n.profileNextReward(
                    nextReward.reward.level,
                    nextReward.customRewardName,
                  );
    final progressLabel = levelState.isMaxLevel
        ? l10n.profileLevelProgressMax(
            levelState.masteryStars,
            levelState.xpToNextMasteryStar,
          )
        : l10n.profileLevelProgressNext(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Lv.${levelState.level} ${l10n.playerLevelName(levelState.level, sportId: sportId)}',
                      maxLines: 1,
...
class _ProfileLevelIllustration extends StatelessWidget {
  ...
  const _ProfileLevelIllustration({
    required this.level,
    required this.sportId,
  });
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    l10n.playerLevelIllustrationLabel(
                      level,
                      sportId: sportId,
                    ),
                    style: Theme.of(context).textTheme.labelMedium?.copyWith(
