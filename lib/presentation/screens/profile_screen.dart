        ...
        child: Ink(
          ...
          child: Row(
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Lv.${levelState.level} ${l10n.playerLevelName(levelState.level)}',
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ...
                    const SizedBox(height: 2),
                    Text(
                      l10n.playerLevelStageName(levelState.level),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
              ...
              const SizedBox(width: 12),
              _ProfileLevelIllustration(level: levelState.level),
            ],
          ),
        ),
      ),
...
class _ProfileLevelIllustration extends StatelessWidget {
  ...
  const _ProfileLevelIllustration({required this.level});
