    ...
    final content = Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (!isMealSticker && !isQuizSticker) ...[
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(item.icon, size: 14, color: tint),
            const SizedBox(width: 6),
            Text(
              item.title,
    ...
    return Column(
      ...
      children: [
        ...
        if (question != null) ...[
          ...
          _buildQuizStickerPanel(
            label: _l10n.diaryQuizQuestionLabel,
            value: question.prompt(_isKo),
            tint: sticker.tint,
            background: sticker.tint.withValues(alpha: _isDark ? 0.18 : 0.10),
          ),
          ...
          _buildQuizStickerPanel(
            ...
            tint: sticker.tint,
            background: sticker.tint.withValues(alpha: _isDark ? 0.26 : 0.16),
          ),
        ] else ...[
          const SizedBox(height: 12),
          Container(
  ...
  Widget _buildQuizStickerPanel({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: tint.withValues(alpha: _isDark ? 0.34 : 0.24),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
