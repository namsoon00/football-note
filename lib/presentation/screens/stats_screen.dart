        ...
        Wrap(
          ...
          children: [
            ...
            _MetricCard(
              ...
              value: isKo
                  ? '$playerGoals골 $playerAssists도움\n${l10n.matchShotsOnTargetLabel} $shotsOnTarget · ${l10n.matchBallsWonLabel} $ballsWon'
  ...
  Widget build(BuildContext context) {
    ...
    final detailLine = [
      if (entry.playerGoals != null)
        '${l10n.matchGoalsLabel} ${entry.playerGoals}',
      if (entry.playerAssists != null)
        '${l10n.matchAssistsLabel} ${entry.playerAssists}',
      if (entry.shotsOnTarget != null)
        '${l10n.matchShotsOnTargetLabel} ${entry.shotsOnTarget}',
