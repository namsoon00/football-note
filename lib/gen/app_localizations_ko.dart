...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get educationBookHeaderTitle => '태오가 한 장씩 넘겨 읽는 축구의 역사';
  ...
  @override
  String get educationBookHeaderChipChapters => '10개 챕터';

  @override
  String get educationBookHeaderChipRoots => '고대부터 현대까지';

  @override
  String get educationBookHeaderChipTactics => '전술과 전설 정리';

  @override
  String get educationBookHeaderChipSwipe => '책 넘기기 UX';
  ...
  String get educationBookCoverNote =>
      '태오는 이 책을 처음부터 끝까지 읽은 다음, 마음에 남은 연도 다섯 개를 따로 적어 두기로 합니다. 역사 공부는 결국 자신만의 기준점을 만드는 일이라는 것을 알기 때문입니다.';
  ...
  String get educationBookOriginsNote =>
      '태오는 축구가 처음부터 완성된 스포츠가 아니라, 혼란스러운 놀이를 모두가 같은 언어로 바꾸는 긴 협상의 결과였다는 사실을 기록합니다.';
  ...
  String get educationBookWorldCupNote =>
      '태오는 월드컵이 단지 축구 대회가 아니라, 세계가 한 규칙을 공유하고 있음을 보여 주는 거대한 발표회 같다고 적어 둡니다.';
  ...
  String get educationBookClubNote =>
      '태오는 클럽 축구의 역사를 안다는 것이 단순 우승 횟수를 외우는 일보다, 어떤 시대가 누구의 것이었는지 읽는 일에 가깝다고 적어 둡니다.';
  ...
  String get educationBookTacticsNote =>
      '태오는 전술판 앞에서 숫자 배열만 보지 않기로 합니다. 같은 4-3-3이라도 압박 높이, 풀백 위치, 6번의 성향에 따라 전혀 다른 팀이 된다는 것을 기억합니다.';
  ...
  String get educationBookLegendsNote =>
      '태오는 위대한 선수란 기술만 뛰어난 사람이 아니라, 축구를 설명할 때 사람들이 자동으로 떠올리는 장면을 남기는 사람이라고 기록합니다.';
  ...
  String get educationBookAsiaNote =>
      '태오는 2002년을 단순한 한 번의 돌풍으로만 보지 않습니다. 준비 조직, 홈 개최, 세대 교체, 리그 경험이 겹쳐야 큰 장면이 만들어진다는 사실을 메모합니다.';
  ...
  String get educationBookWomenNote =>
      '태오는 역사책이 우승팀만 적는 책이 아니어야 한다고 느낍니다. 누구에게 문이 닫혀 있었고, 그 문이 언제 다시 열렸는지까지 함께 기록해야 진짜 역사가 되기 때문입니다.';
  ...
  String get educationBookModernNote =>
      '태오는 결국 현대 축구의 선수도 과거와 다르지 않다고 느낍니다. 더 많은 데이터가 붙었을 뿐, 좋은 첫 터치와 빠른 판단, 동료와의 호흡이 여전히 경기의 중심입니다.';
  ...
  String get educationBookFinaleNote =>
      '태오는 책장을 닫으며 다음 훈련 일지 첫 줄에 이렇게 적습니다. 축구를 잘 본다는 것은 지금 뛰는 장면만 보는 것이 아니라, 그 장면이 어디에서 왔는지 끝까지 따라가는 일이다.';
}
