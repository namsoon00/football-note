...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get fortuneDailyOutcomeTimes =>
      '아침 첫 알림에서|등교나 출근길에|점심 전에|점심 뒤 잠깐 쉬는 사이에|오후 이동 중에|익숙한 장소에서|메시지를 확인하다가|정리하는 순간에|기다리는 동안에|하루를 마무리할 때';

  @override
  String get fortuneDailyOutcomeSubjects =>
      '반가운 소식이|미뤄둔 일이|찾던 정보가|가벼운 대화가|작은 칭찬이|잊고 있던 약속이|뜻밖의 빈 시간이|편한 선택지가|새로운 단서가|기다리던 답이';

  @override
  String get fortuneDailyOutcomeResults =>
      '하루를 가볍게 만들어줘요.|마음을 조금 편하게 해줘요.|다음 선택을 쉽게 만들어줘요.|기분이 나아지는 쪽으로 이어져요.|작은 보상처럼 남아요.|남은 일정을 편하게 열어줘요.|헷갈리던 마음을 바로잡아줘요.|짧은 웃음으로 번져요.|하루 끝에 만족으로 돌아와요.|필요한 쪽으로 자연스럽게 이어져요.';
