...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get educationScreenTitle => '태오의 월드컵 역사책';
  ...
  @override
  String get educationBookCoverTitle => '태오와 함께 읽는 월드컵 대연대기';

  @override
  String get educationBookCoverSubtitle => '1930 우루과이부터 2026 북중미 전망까지';

  @override
  String get educationBookCoverStory =>
      '태오는 훈련을 마친 뒤 오래된 월드컵 프로그램북이 꽂힌 서가 앞에 섭니다. 첫 장을 펼치자 몬테비데오의 항구, 마라카낭의 관중석, 아즈테카의 고지대, 루사일의 밤하늘이 한 권의 책 안에서 이어집니다.\n\n이번 책은 축구 전체 역사가 아니라 남자 FIFA 월드컵만 따라갑니다. 1930년 제1회 월드컵부터 가장 최근에 끝난 2022 카타르 월드컵, 그리고 아직 열리기 전인 2026 북중미 대회 전망까지 태오에게 차근차근 설명해 주는 형식입니다. 그래서 태오는 우승팀만 외우지 않고, 누가 시대를 바꿨는지, 어떤 사건이 대회를 흔들었는지, 왜 어떤 장면은 수십 년이 지나도 계속 소환되는지를 함께 읽습니다.\n\n책장을 덮지 않기 전에 태오는 빈 종이에 1930, 1950, 1958, 1970, 1986, 1998, 2002, 2010, 2018, 2022, 2026을 적어 둡니다. 첫 출발, 가장 유명한 충격, 펠레의 등장, 황금 브라질, 마라도나의 여름, 32개국 시대, 한국의 4강, 아프리카 첫 개최, VAR 시대, 메시의 완성, 48개국 확장을 한 줄로 잡아 두면 월드컵 전체 지도가 훨씬 선명해지기 때문입니다.';
  ...
  @override
  String get educationBookOriginsTitle => '바다를 건너 시작된 첫 세 번의 월드컵';
  ...
  String get educationBookOriginsStory =>
      '태오는 첫 번째 본문에서 선수들이 비행기보다 배를 더 많이 타던 시대의 월드컵을 만납니다. 유럽 팀들이 몇 주씩 항해해 우루과이로 향했고, 개최국은 독립 100주년을 기념하며 센테나리오 경기장을 서둘러 완성했습니다. 월드컵의 출발은 이미 모험담처럼 시작된 셈이었습니다.\n\n1930년 우루과이는 결승에서 아르헨티나를 4대2로 꺾고 초대 챔피언이 됐고, 아르헨티나의 기예르모 스타빌레는 첫 대회 득점왕으로 남았습니다. 하지만 낭만만 있었던 것은 아닙니다. 1934년 이탈리아 대회는 무솔리니 정권의 선전 그림자 속에서 열렸고, 1938년 프랑스 대회는 전쟁 전야의 긴장 위에서 치러졌습니다.\n\n태오는 초창기 월드컵부터 이미 장거리 이동, 정치적 압박, 보이콧, 판정 논쟁이 함께 움직였다는 점에 놀랍니다. 그래서 첫 세 대회를 볼 때는 단순히 누가 우승했는지가 아니라, 월드컵이 얼마나 빨리 세계사의 한복판으로 들어갔는지를 같이 읽기로 합니다.';
  ...
  @override
  String get educationBookWorldCupTitle => '전쟁 뒤에 돌아온 월드컵과 브라질의 황금 시대';
  ...
  String get educationBookWorldCupStory =>
      '1942년과 1946년 월드컵이 전쟁으로 멈춘 뒤, 1950년 브라질 대회는 다시 시작된 세계 축구의 축제처럼 보였습니다. 그런데 태오는 가장 먼저 해피엔딩이 아니라 마라카낭의 침묵을 읽게 됩니다. 우루과이가 브라질을 꺾은 마라카낭의 충격은 월드컵이 개최국의 꿈도 산산이 부술 수 있다는 사실을 상징했습니다.\n\n그 다음 장면은 더 전설적입니다. 1954년 서독의 베른의 기적, 1958년 17세 펠레의 등장, 1962년 부상당한 펠레 대신 가린샤가 팀을 이끈 이야기, 1966년 잉글랜드의 유일한 우승, 그리고 1970년 멕시코에서 완성된 브라질의 황금 축구까지 흐름이 끊이지 않습니다.\n\n태오는 이 시대를 읽으며 월드컵이 단순한 우승표가 아니라 새로운 영웅이 태어나고, 어떤 국가는 국민적 상처를 입고, 어떤 전술은 전 세계의 기준이 되는 장소라는 걸 배웁니다. 그래서 1950년부터 1970년까지는 재개, 충격, 천재, 복수, 완성이라는 다섯 단어로 정리합니다.';
  ...
  @override
  String get educationBookClubTitle => '새 트로피, 토탈 풋볼, 그리고 뜨거운 논쟁의 시대';
  ...
  String get educationBookClubStory =>
      '1974년부터 태오의 책에는 새로운 트로피가 등장합니다. 네덜란드는 요한 크루이프와 함께 자유롭게 자리를 바꾸는 토탈 풋볼을 보여 줬고, 서독은 프란츠 베켄바워를 앞세워 그 혁명을 결승에서 막아 냈습니다. 월드컵은 아름다운 이상과 냉정한 현실이 정면으로 부딪히는 실험실처럼 보였습니다.\n\n하지만 이 시기의 월드컵은 축구 자체만으로 설명되지 않습니다. 1978년 아르헨티나 대회는 군사정권의 그림자 속에서 열렸고, 1982년 스페인 대회는 파올로 로시의 복귀와 프랑스-서독 준결승의 충돌 장면으로 기억됩니다. 1986년에는 마라도나가 같은 대회에서 신의 손과 5명 돌파 골을 모두 남기며 월드컵 서사의 정점에 섰습니다.\n\n1990년 이탈리아 대회까지 오면 태오는 월드컵이 얼마나 복잡한 감정의 묶음인지 실감합니다. 로저 밀라의 춤, 베켄바워의 감독 우승, 눈물 속에 끝난 마라도나의 결승전이 한 대회들 속에 함께 남아 있기 때문입니다. 그래서 이 시기는 전술 혁신, 정치의 그림자, 초인적 개인기, 그리고 논쟁이 한꺼번에 달려드는 시대라고 적습니다.';
  ...
  @override
  String get educationBookTacticsTitle => '세계화된 월드컵과 극장 같은 결승전';
  ...
  String get educationBookTacticsStory =>
      '1994년 미국 월드컵으로 넘어오자 태오는 월드컵이 이제 완전히 거대한 글로벌 쇼가 됐다는 걸 느낍니다. 미국의 거대한 경기장, 로마리우의 미소, 그리고 결승전 승부차기에서 하늘로 날아간 로베르토 바조의 슛이 같은 장면 안에 들어 있습니다. 축구를 잘 모르는 나라에서도 월드컵은 엄청난 이벤트가 될 수 있다는 사실이 증명된 대회였습니다.\n\n1998년 프랑스 대회는 32개국 체제의 시작이었고, 지단의 헤더 두 골과 호나우두의 결승전 직전 컨디션 논란이 강하게 남았습니다. 2002년 한일 월드컵은 한국의 4강, 히딩크의 리더십, 안정환과 박지성의 장면들, 그리고 8골을 넣은 호나우두의 복수가 한꺼번에 들어 있는 대회였습니다.\n\n2006년 독일 대회에서는 월드컵이 다시 축구축제의 표정을 되찾았지만, 결승전 마지막엔 지단의 박치기가 모든 공기를 바꿔 놓았습니다. 태오는 이 네 대회를 읽으며 월드컵이 더 커질수록 드라마도 더 커진다는 사실을 배웁니다. 그래서 1994년부터 2006년까지는 세계화, 확장, 한국의 여름, 마지막 반전이라는 문장으로 정리합니다.';
  ...
  @override
  String get educationBookLegendsTitle => '데이터 시대의 월드컵과 메시의 완성';
  ...
  String get educationBookLegendsStory =>
      '2010년 남아공 월드컵 장을 펼치자 태오는 먼저 부부젤라 소리를 듣게 됩니다. 아프리카 대륙 최초의 월드컵은 소리와 색깔부터 달랐고, 스페인은 연장 결승에서 이니에스타의 골로 자신들의 시대를 완성했습니다. 같은 대회에서 수아레스의 골라인 핸드볼, 가나의 탈락, 그리고 결과를 계속 맞힌 문어 파울까지 등장하니 월드컵은 언제나 진지함과 밈이 함께 간다는 사실도 알게 됩니다.\n\n2014년 브라질 대회는 홈팀이 독일에게 7대1로 무너진 미네이랑의 충격을 남겼고, 미로슬라프 클로제는 통산 16호 골로 월드컵 최다 득점 기록을 새로 썼습니다. 2018년 러시아 대회에서는 음바페가 10대 슈퍼스타로 떠오르고 프랑스가 다시 우승했으며, 크로아티아는 연장전을 거듭 버티며 결승까지 올라갔습니다.\n\n그리고 2022년 카타르에서 태오는 마침내 메시의 우승을 읽습니다. 모로코의 4강, 아르헨티나와 프랑스의 미친 결승전, 음바페의 해트트릭, 에밀리아노 마르티네스의 세이브까지 이어지자 태오는 어떤 대회는 한 사람의 커리어를 완성하고, 어떤 대회는 대륙 전체의 상한선을 다시 써 놓는다는 걸 깨닫습니다.';
  ...
  @override
  String get educationBookAsiaTitle => '월드컵을 사람으로 기억하는 방법';
  ...
  String get educationBookAsiaStory =>
      '태오는 어느 순간 연도보다 사람 이름으로 월드컵을 떠올리기 시작합니다. 대회를 만든 행정가 쥘 리메, 두 번 연속 우승한 비토리오 포초, 세 번 우승한 펠레, 선수와 감독으로 모두 정상에 선 베켄바워, 월드컵 자체를 한 사람 얼굴처럼 만든 마라도나가 차례로 등장합니다.\n\n이 장에서는 영웅만 나오지 않습니다. 가린샤처럼 부상당한 팀을 대신 업고 간 선수, 호나우두처럼 무너졌던 결승의 악몽을 4년 뒤 복수로 바꾼 선수, 지단처럼 천재와 폭발을 함께 남긴 선수, 메시처럼 마지막 한 칸을 끝내 채운 선수도 등장합니다. 태오는 월드컵이 기록의 경쟁인 동시에 사람의 서사가 가장 크게 증폭되는 장소라는 걸 이해합니다.\n\n그래서 태오는 인물을 외울 때 이름만 적지 않기로 합니다. 펠레는 1958와 1970, 마라도나는 1986 잉글랜드전, 베켄바워는 1974와 1990, 호나우두는 2002, 메시는 2022처럼 연도와 장면을 붙여 기억해야 살아 있는 역사책이 된다고 믿기 때문입니다.';
  ...
  @override
  String get educationBookWomenTitle => '이변, 논쟁, 그리고 월드컵 밖으로 번진 이야기';

  @override
  String get educationBookWomenSubtitle => '전쟁, 독재, 도둑맞은 트로피, 기술 판독까지';

  @override
  String get educationBookWomenStory =>
      '태오는 월드컵 역사책이 우승팀만 나열하면 절반만 설명하는 셈이라는 걸 이 장에서 배웁니다. 어떤 대회는 전쟁 때문에 열리지 못했고, 어떤 대회는 독재 정권의 그림자 속에서 치러졌으며, 어떤 대회는 경기장 밖 사건이 오히려 더 유명해졌습니다. 월드컵은 늘 세계의 공기를 그대로 빨아들였습니다.\n\n1966년에는 쥘 리메 트로피가 개막 전에 도난당했다가 피클스라는 강아지 덕분에 발견되는 믿기 힘든 사건이 벌어졌습니다. 1982년 바티스통이 쓰러진 장면, 2010년 램파드의 오심 골, 2014년 골라인 기술, 2018년 VAR, 2022년 반자동 오프사이드까지 따라가자 태오는 월드컵이 판정 기술의 역사책이기도 하다는 걸 알게 됩니다.\n\n그래서 태오는 월드컵을 볼 때 늘 두 개의 질문을 같이 적습니다. 경기장 안에서는 누가 이겼는가, 경기장 밖에서는 무엇이 바뀌었는가. 이 두 질문을 같이 붙여야 진짜 역사책이 된다고 느끼기 때문입니다.';
  ...
  @override
  String get educationBookModernTitle => '다음 장은 2026, 태오의 예측 노트';

  @override
  String get educationBookModernSubtitle => '48개국 월드컵이 바꿀 관전 포인트';

  @override
  String get educationBookModernStory =>
      '이제 태오는 마지막 본문에서 아직 열리지 않은 2026년 북중미 월드컵을 바라봅니다. 48개국, 104경기, 세 나라 공동 개최라는 조건만 봐도 이전 월드컵과는 결이 다릅니다. 대회가 길어질수록 선발 11명보다 스쿼드 깊이, 회복 관리, 장거리 이동 대응이 훨씬 더 중요해질 것이라는 점부터 먼저 보입니다.\n\n태오는 우승팀을 단정하기보다 어떤 팀이 유리한 조건을 갖추는지 메모합니다. 압박과 빌드업을 모두 해낼 수 있는 미드필드, 세트피스로 경기를 잠글 수 있는 디테일, 벤치 자원까지 포함한 득점 분산, 그리고 낯선 상대를 빨리 분석하는 코칭 스태프가 더 큰 가치를 가질 것 같다고 적습니다. 전통 강호들은 여전히 강력하겠지만, 48개국 체제는 뜻밖의 대진과 다크호스를 더 많이 만들 가능성도 큽니다.\n\n그래서 태오는 2026년을 맞히기 게임이 아니라 관찰 훈련의 장으로 봅니다. 개최국 미국, 멕시코, 캐나다 중 누가 가장 멀리 갈지, 남미와 유럽 강호 중 누가 새 시대의 표준을 만들지, 아시아와 아프리카 팀 중 누가 또 상한선을 밀어 올릴지 상상하면서요.';
  ...
  @override
  String get educationBookFinaleSubtitle => '1930에서 2026까지, 월드컵을 한 줄로 묶는 법';

  @override
  String get educationBookFinaleStory =>
      '마지막 장을 덮은 태오는 월드컵이 결국 4년에 한 번 열리는 거대한 요약본이라는 걸 깨닫습니다. 배를 타고 우루과이로 향하던 선수들부터, 위성 중계와 VAR 속에서 뛰는 현대 선수들까지 같은 대회 이름 아래 연결돼 있기 때문입니다.\n\n어떤 시대는 펠레와 마라도나, 메시 같은 초인으로 기억되고, 어떤 시대는 마라카낭의 충격이나 7대1 같은 스코어로 기억되며, 어떤 시대는 트로피 도난, 전쟁, 기술 판독 논쟁으로 남습니다. 태오는 그래서 월드컵 역사책을 읽는 일은 단순 암기가 아니라, 같은 경기 안에 세계사의 공기까지 같이 읽는 훈련이라고 생각합니다.\n\n그래서 태오는 책을 덮기 전에 1930, 1950, 1958, 1970, 1986, 1998, 2002, 2010, 2018, 2022, 2026을 다시 한 번 순서대로 읽습니다. 한 장면을 볼 때 그 뒤에 붙는 연도와 개최국, 주인공과 사건이 함께 떠오른다면, 앞으로 경기를 볼 때도 역사를 훨씬 길게 느낄 수 있을 것이라고 믿기 때문입니다.';
