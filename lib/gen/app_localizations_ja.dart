...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get fortuneDailyOutcomeTimes =>
      '朝にスマホを見る時に|家を出る前に|学校や仕事へ向かう途中で|昼ごはんを選ぶ時に|午後にメッセージを見る時に|少し休もうと座る時に|かばんや机を片づける時に|誰かを待つ間に|夕食の前後に|寝る前に一日を振り返る時に';

  @override
  String get fortuneDailyOutcomeSubjects =>
      'うれしい連絡が|必要な通知が|探していた情報が|短い会話が|誰かのひと言が|忘れていた予定が|空いた時間が|迷っていた選択肢が|小さな発見が|待っていた返事が';

  @override
  String get fortuneDailyOutcomeResults =>
      'やることを一つ減らしてくれます。|次にすることをすぐ決めやすくします。|はっきり笑える理由になります。|近くの人との話を始めやすくします。|見落としそうだったことを思い出させます。|待ち時間を短く感じさせます。|すぐ使えるヒントになります。|夜に思い出しても少しうれしく残ります。|散らかった考えを一行にしてくれます。|一日の終わりを楽にしてくれます。';
