...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get startupErrorDetailsLabel => 'エラー情報';

  @override
  String get startupErrorStepLabel => 'ステップ';

  @override
  String get startupErrorMessageLabel => 'メッセージ';
  ...
  String get worldCupRankingsIntro =>
      'FIFA公式の試合詳細で確認できる選手記録を集計します。得点は公式得点者リスト、アシストはFIFAがアシスト選手IDを提供している試合のみ、イエローカードとレッドカードは公式カード記録から集計します。';
  ...
  @override
  String get worldCupDisciplineRankingsTitle => '警告/退場ランキング';

  @override
  String get worldCupYellowCardRankingsTitle => 'イエローカードランキング';

  @override
  String get worldCupRedCardRankingsTitle => 'レッドカードランキング';
  ...
  String get worldCupAssistRankingsEmpty =>
      'FIFAがアシスト選手IDを提供している試合のみ集計できるため、現在表示できるアシストはありません。';

  @override
  String get worldCupDisciplineRankingsEmpty =>
      'FIFA公式の警告/退場記録がまだないため、表示できる懲戒ランキングはありません。';

  @override
  String get worldCupYellowCardRankingsEmpty =>
      'FIFA公式のイエローカード記録がまだないため、表示できる選手はいません。';

  @override
  String get worldCupRedCardRankingsEmpty =>
      'FIFA公式のレッドカード記録がまだないため、表示できる選手はいません。';
  ...
  @override
  String get worldCupYellowCardLabel => '警告';

  @override
  String get worldCupRedCardLabel => '退場';
  ...
  @override
  String get worldCupKnockoutPathTitle => '決勝までの相手';

  @override
  String get worldCupKnockoutPathSubtitle =>
      'このチームが各ラウンドを勝ち上がると仮定し、決勝までに対戦する可能性のある相手を表示します。';
  ...
  @override
  String get worldCupKnockoutPathOpponentPending => '相手未確定';

  @override
  String get worldCupKnockoutPathEliminated => 'このラウンドで敗退';
  ...
  @override
  String get profilePlayerNumberLabel => '選手番号';

  @override
  String get profilePlayerNumberHint => '例: 10';
  ...
  @override
  String get diaryStickerFortune => '今日のひとこと';
  ...
  @override
  String get diaryFortunePinSummary => '今日のひとことを日記ステッカーとして貼れます。';

  @override
  String get diaryFortuneStorySentence => '今日のひとことから残したい場面を書きます。';

  @override
  String get diaryFortuneNoteTitle => 'ひとこと運勢メモ';
  ...
  @override
  String get mealCompanionFoodsLabel => '一緒に食べたもの';

  @override
  String get mealCompanionFoodsEmpty => '追加の食べ物は未選択';

  @override
  String get mealCompanionFoodsChooseAction => '食べ物を選択';

  @override
  String get mealCompanionFoodsEditAction => '編集';

  @override
  String get mealCompanionFoodsSheetTitle => '一緒に食べたものを選択';

  @override
  String get mealFoodSearchLabel => '食べ物を検索';

  @override
  String get mealFoodSearchHint => 'キムチ、牛乳、バナナなど';

  @override
  String get mealFoodSelectionClear => 'すべて解除';

  @override
  String get mealFoodSelectionDone => '完了';

  @override
  String mealFoodNutritionLine(int kcal, int carbs, int protein, int fat) {
    return '$kcal kcal · 炭 ${carbs}g · たんぱく質 ${protein}g · 脂質 ${fat}g';
  }
  ...
  String mealSelectedFoodsNutritionPreview(int kcal, int protein) {
    return '追加の食べ物 約$kcal kcal · たんぱく質 ${protein}g';
  }

  @override
  String get mealFoodCategoryMain => 'メイン';

  @override
  String get mealFoodCategoryProtein => 'たんぱく質';

  @override
  String get mealFoodCategorySide => '副菜';

  @override
  String get mealFoodCategorySoup => '汁物';

  @override
  String get mealFoodCategoryCarb => '炭水化物';

  @override
  String get mealFoodCategoryFruit => '果物';

  @override
  String get mealFoodCategorySnack => '間食';

  @override
  String get mealFoodCategoryDrink => '飲み物';
  ...
  @override
  String get mealFoodBibimbap => 'ビビンバ';

  @override
  String get mealFoodFriedRice => 'チャーハン';

  @override
  String get mealFoodGimbap => 'キンパ';

  @override
  String get mealFoodCurryRice => 'カレーライス';

  @override
  String get mealFoodPorkCutlet => 'とんかつ';

  @override
  String get mealFoodJajangmyeon => 'ジャージャー麺';

  @override
  String get mealFoodJjampong => 'チャンポン';

  @override
  String get mealFoodTteokbokki => 'トッポッキ';

  @override
  String get mealFoodPasta => 'パスタ';

  @override
  String get mealFoodHamburger => 'ハンバーガー';

  @override
  String get mealFoodPizza => 'ピザ';

  @override
  String get mealFoodPorkBelly => '豚バラ焼き';

  @override
  String get mealFoodJeyukBokkeum => '豚肉炒め';

  @override
  String get mealFoodBeefSteak => 'ビーフステーキ';

  @override
  String get mealFoodDakgalbi => 'タッカルビ';

  @override
  String get mealFoodOmurice => 'オムライス';

  @override
  String get mealFoodUdon => 'うどん';

  @override
  String get mealFoodColdNoodles => '冷麺';

  @override
  String get mealFoodSoybeanNoodles => '豆乳麺';

  @override
  String get mealFoodDumplingSoup => '餃子スープ';
  ...
  @override
  String get mealFoodPickledRadish => 'たくあん';

  @override
  String get mealFoodSeasonedBeanSprouts => 'もやしナムル';

  @override
  String get mealFoodSpinachNamul => 'ほうれん草ナムル';

  @override
  String get mealFoodSeaweedSalad => 'わかめ和え';

  @override
  String get mealFoodLettuce => 'レタス';

  @override
  String get mealFoodCucumber => 'きゅうり';

  @override
  String get mealFoodTomato => 'トマト';

  @override
  String get mealFoodAvocado => 'アボカド';

  @override
  String get mealFoodBroccoli => 'ブロッコリー';

  @override
  String get mealFoodSweetPotato => 'さつまいも';

  @override
  String get mealFoodPotato => 'じゃがいも';

  @override
  String get mealFoodCorn => 'とうもろこし';

  @override
  String get mealFoodBoiledEgg => 'ゆで卵';

  @override
  String get mealFoodFriedEgg => '目玉焼き';

  @override
  String get mealFoodOmelet => 'オムレツ';

  @override
  String get mealFoodCheese => 'チーズ';

  @override
  String get mealFoodTunaCan => 'ツナ缶';

  @override
  String get mealFoodHam => 'ハム';

  @override
  String get mealFoodSausage => 'ソーセージ';

  @override
  String get mealFoodBacon => 'ベーコン';

  @override
  String get mealFoodMackerel => 'サバ';

  @override
  String get mealFoodShrimp => 'エビ';

  @override
  String get mealFoodSquid => 'イカ';

  @override
  String get mealFoodBeans => '豆';

  @override
  String get mealFoodChickpeas => 'ひよこ豆';

  @override
  String get mealFoodLentils => 'レンズ豆';

  @override
  String get mealFoodSeaweedSoup => 'わかめスープ';

  @override
  String get mealFoodBeefSoup => '牛肉スープ';

  @override
  String get mealFoodEggSoup => '卵スープ';

  @override
  String get mealFoodTofuSoup => '豆腐スープ';

  @override
  String get mealFoodVegetableSoup => '野菜スープ';

  @override
  String get mealFoodMisoSoup => '味噌汁';

  @override
  String get mealFoodChickenSoup => 'チキンスープ';

  @override
  String get mealFoodDumplings => '餃子';

  @override
  String get mealFoodFriedSnack => '揚げ物';

  @override
  String get mealFoodFrenchFries => 'フライドポテト';

  @override
  String get mealFoodRiceCake => '餅';

  @override
  String get mealFoodBreadSlice => '食パン';

  @override
  String get mealFoodToast => 'トースト';

  @override
  String get mealFoodOatmeal => 'オートミール';

  @override
  String get mealFoodCereal => 'シリアル';

  @override
  String get mealFoodGranola => 'グラノーラ';

  @override
  String get mealFoodMixedNuts => 'ミックスナッツ';

  @override
  String get mealFoodAlmonds => 'アーモンド';

  @override
  String get mealFoodIceCream => 'アイスクリーム';

  @override
  String get mealFoodChocolate => 'チョコレート';

  @override
  String get mealFoodCookie => 'クッキー';

  @override
  String get mealFoodCake => 'ケーキ';

  @override
  String get mealFoodYogurt => 'ヨーグルト';

  @override
  String get mealFoodGreekYogurt => 'ギリシャヨーグルト';

  @override
  String get mealFoodProteinShake => 'プロテインシェイク';

  @override
  String get mealFoodWheyProtein => 'ホエイプロテイン';

  @override
  String get mealFoodMilk => '牛乳';

  @override
  String get mealFoodSoyMilk => '豆乳';

  @override
  String get mealFoodJuice => 'ジュース';

  @override
  String get mealFoodSportsDrink => 'スポーツドリンク';

  @override
  String get mealFoodCoffeeLatte => 'カフェラテ';

  @override
  String get mealFoodAmericano => 'アメリカーノ';

  @override
  String get mealFoodCola => 'コーラ';

  @override
  String get mealFoodWater => '水';

  @override
  String get mealFoodBanana => 'バナナ';

  @override
  String get mealFoodApple => 'りんご';

  @override
  String get mealFoodOrange => 'オレンジ';

  @override
  String get mealFoodGrapes => 'ぶどう';

  @override
  String get mealFoodStrawberries => 'いちご';
  ...
  @override
  String get mealCalorieCoachEmpty => '食べ物を記録すると、ご飯の量と選択した項目から大まかなカロリーを計算します。';
  ...
  @override
  String get fortuneDialogTitle => '今日のひとこと';

  @override
  String get fortuneDialogSubtitle => '';

  @override
  String get fortuneDialogOverviewTitle => 'ひとことを見る';
  ...
  @override
  String get fortuneDatabaseSectionDailyOutcomes => '短い運勢文';
  ...
  String get fortuneShortLines =>
      '送る前にもう一度読むとミスが減ります。|最初のパスは安全で十分です。|動く前にバッグのファスナーを確認します。|水を一口飲むと入りが楽になります。|最初の5分はゆっくり入ります。|靴ひもを結び直すと一歩目が軽くなります。|選択肢を減らすと集中が続きます。|ミスの後は次のボールが答えです。|短い返事でも先に送ると楽になります。|動画は10秒でもポイントが見えます。|空いたスペースを見るとパスコースが開きます。|一度声を出すとチームが動きやすくなります。|終わりの写真一枚で記録が残ります。|ほめ言葉を一つ先に出すと会話が早く進みます。|記録は一行だけで十分です。|急ぐ時は3秒止まると選びやすいです。|ファーストタッチを近くに置くと次が楽です。|ボールなしで動くともう一度受けられます。|今片づけると後で時間が残ります。|待つ間に姿勢を変えると体が固まりにくいです。|ごはんはゆっくり、スマホは少し置きます。|詰まったら一番簡単な所から始めます。|迷ったら紙に二行で書きます。|遅れた返事は短くても十分です。|新しい情報はスクショすると探しやすいです。|気に入った文は保存すると後で使えます。|練習後に伸ばすと明日の体が楽です。|先にあいさつすると会話が早く開きます。|スペースが見えたら一拍早く動きます。|ルーティンは10分ずつ区切ると続きます。|きつければ強度を下げます。|良い場面はメモするとまた使えます。|通知を一つ切ると集中が伸びます。|次の予定は5分早く入れます。|パス前に顔を上げると選択肢が増えます。|ドリブルは最初の方向だけ決めます。|帰る前にバッグを空にすると明日が楽です。|休み時間は水から取ります。|基本を入れた日はミスが早く減ります。|終える前のチェック一つが明日の時間を作ります。|靴下を一つ見つけたら出発は勝ちです。|最初のタッチが静かなら一日が崩れにくいです。|返事は短くても遅れなければすっきりします。|足より先に目を働かせます。|バッグのレシートを一枚抜くと頭も軽くなります。|少し笑って流すと次の場面が早く来ます。|最初の選択はシンプルなほど足が迷いません。|ボトルを満たすとルーティンもついてきます。|記録一行で明日の自分が迷いにくいです。|やさしいパス一つでチームが起きます。|肩の力を抜くと視野が一つ広がります。|空欄を一つ消すと頭も片づきます。|遅れた返事も淡々としていれば十分です。|速さが絡まったら靴ひもから見ます。|小さな片づけ一つで午後の時間が残ります。|ほめ言葉一つでチームチャットが温まります。|間食は軽く、集中は長く持ちます。|逃したボールより次の位置が大事です。|メモの一行目は思ったより使えます。|整ったバッグは明日の朝のチートキーです。|カフェのドアが開くといい香りがついてきます。|好きな曲の最初で歩き方が少し早くなります。|エレベーター前でなじみの名前に会います。|昼のメニューが一回でしっくり来ます。|ふと見た写真一枚で口元が上がります。|コンビニの新商品で目が少し光ります。|待っていた返事が短くても先に届きます。|角を曲がる前にいい香りがあいさつします。|しおりの間の忘れたメモで笑えます。|空色がきれいな瞬間に歩みが少し遅くなります。|好きな文が急にぴったり浮かびます。|通知一つで少し胸が弾みます。|新しく買った物が手にしっくり来ます。|鏡の前の表情がいつもより良く見えます。|散歩道の角に小さなときめきがあります。|好きな絵文字が会話をやわらかく開きます。|バスの窓側席で考えが気持ちよくほどけます。|傘をたたむ瞬間に空気がさっぱり変わります。|好きなおやつが最後の一つで残っています。|帰り道の灯りがいつもよりきれいです。';
  ...
  String fortuneGeneratedLinkedDailyLine(
    ...
    return '$nameさん、$elementFlow / $fortuneTheme';
  }
  ...
  String fortuneGeneratedLuckyInfoLine(int number, String color) {
    return 'ラッキーナンバーは$number、カラーは$colorです。';
  }
  ...
  String get fortuneMyeongliTenGodDailyLines =>
      '今日やることを三つに分ける日です。|グループ連絡で返す言葉だけ選ぶ日です。|休憩と小さなおやつを入れる日です。|いつもと違う言い方で説明する日です。|急な提案を条件ごとに比べる日です。|かばんと机の上を片づける日です。|遅らせた返事をすぐ決める日です。|約束の時間と順番を守る日です。|見逃した通知をもう一度開く日です。|一人で抱えたことを助けてもらって解く日です。';

  @override
  String get fortuneMyeongliTwelveStageDailyLines =>
      '朝の最初の行動を小さく始める日です。|表情と話し方の変化に早く気づく日です。|席と持ち物を先に整える日です。|自分の速さで一つずつ進める日です。|午前中にたまったことを始める日です。|いらない予定と物を減らす日です。|休む時間を先に入れる日です。|終えることを一つ選んで片づける日です。|前に書いたメモをもう一度使う日です。|やめることと続けることを分ける日です。|新しく試すことを小さく決める日です。|明日やることを夜に先に書く日です。';

  @override
  String get fortuneMyeongliBranchRelationDailyLines =>
      '身近な人と一緒に片づける日です。|意見がぶつかった後でやることを決め直す日です。|絡んだことを順番に書く日です。|誤解をすぐ聞いて小さくする日です。|乱れた約束をもう一度合わせる日です。|いろいろな人の言葉を一か所にまとめる日です。|慣れた場所でやることを進める日です。';

  @override
  String get fortuneSajuElementFlows =>
      'ゆっくり始めて午前中に速さを出す日です。|うれしい名前からの連絡に返す日です。|なくした物や必要な情報を探す日です。|部屋や机の一か所を片づける日です。|好きな音楽やおやつで気分を上げる日です。|二つの選択肢から一つを選ぶ日です。|身近な人に先に話しかける日です。|短い時間で一つのことだけ進める日です。|助けを受けて早く終える日です。|少し休んでまた始める日です。|思いついたことをすぐメモする日です。|いつもの場所で必要な手がかりを探す日です。|たまった通知やメモを消す日です。|相手の表情を見て言葉を選ぶ日です。|約束の時間より10分早く動く日です。|少し勇気を出して先に話す日です。|待っていた知らせをもう一度確かめる日です。|楽な速さで最後まで進める日です。|止まったことを小さな手順に分ける日です。|自分で決めた順番で動く日です。|先に笑ってあいさつする日です。|変わった予定や場所を早く確かめる日です。|待っていた答えをもう一度確かめる日です。|静かに準備したことを見せる日です。';

  @override
  String get fortuneSajuElementFlowExtras =>
      '相手の話を最後まで聞く日です。|予想と違うことが起きても選び直す日です。|負担の少ないことから始める日です。|一人で決める前に一度聞く日です。|小さな親切にすぐ気づく日です。|メニューや道順を早く選ぶ日です。|終わったことにチェックを付ける日です。|気に入ったほうを5分だけ試す日です。|遅れていた返事を受け取る日です。|やることの答えを一行で書く日です。|たまたま見た言葉や写真からヒントを得る日です。|周りの物を元の場所に戻す日です。|新しく気になる物や話題を見つける日です。|考えを紙に書く日です。|問題の最初の手がかりを早く探す日です。|短く言って意味を伝える日です。|やわらかく頼んで返事を聞く日です。|小さなほめ言葉を聞いたり渡したりする日です。|5分ほど休んで次を始める日です。|約束の時間と移動時間を合わせる日です。|通知を減らして集中を続ける日です。|小さな失敗をすぐ直す日です。|見落とした物や情報を探す日です。|午後からやることに速さを出す日です。|静かに準備した内容を認められる日です。|最初の感じより確かめた内容を信じる日です。|予定を少し変えても自然に動く日です。|先にあいさつして反応をもらう日です。|始めることを小さく決める日です。|終える前にもう一度確かめる日です。|待つ時間を短く感じる日です。|もう一度笑えることに会う日です。|新しい提案を断る前に聞く日です。|固い言葉より楽な言葉で伝える日です。|正確に見てすぐ言う日です。|気になることを調べたり聞いたりする日です。';

  @override
  String get fortuneSajuFortuneThemes =>
      '朝の通知にうれしい名前が出ます。|昼前に後回しのメッセージを送ります。|待っていた返事が午後までに届きます。|初めて見る提案も条件を比べてすぐ決めます。|小さな買い物を減らして必要な物を選びます。|複雑だった考えをメモ一行にまとめます。|身近な人と短く話して気持ちが楽になります。|いつもの道で必要な案内に従います。|午後に後回しのことを20分集中して終えます。|誰かの短い言葉で今日の選択が楽になります。|予定が変わって、より楽な時間ができます。|忘れていた約束や持ち物を思い出します。|片づけながら探していた物を取り出します。|今日選んだ色や物で気分を切り替えます。|待つ時間が減って次のことを早く始めます。|小さなほめ言葉を受け取ったり先に渡したりします。|必要な情報が会話や通知で入ってきます。|一人の時間に後回しのことを静かに片づけます。|短い散歩や移動中に解決方法が浮かびます。|迷っていた選択を夕方前に決めます。|言われなくても相手が求めていることに気づきます。|小さな失敗をすぐ直して笑って流します。|相手の反応を見て言葉を変えます。|長く後回しにした連絡を今日もう一度開きます。|新しく知った情報で選ぼうとしていたものを変えます。|水一杯や短い休憩で気分が早く戻ります。|お金より時間を節約する選択をします。|偶然会った人が次の約束につながります。|静かに集中したことが見える結果として残ります。|気になっていたことが思ったより簡単に終わります。|夜にもう一度確かめて見落としを拾います。|誰かの頼みを片づけながら役立つ情報を得ます。|待っていた物や知らせを自分で確かめます。|思ったより話しやすい人に会います。|小さな片づけ一つで残りの予定が楽になります。|最初に選んだものをそのまま続けます。';

  @override
  String get fortuneSajuFortuneThemeExtras =>
      '朝の最初の画面で必要な予定をすぐ整理します。|小さな頼みごとを終えてすぐありがとうと言われます。|後回しにした片づけを10分以内に始めます。|気になっていた会話を短くもう一度出します。|思ったより早く空き時間ができます。|軽く選んだ道で探していた店や場所に会います。|先に動いて待つ時間を減らします。|開いていた画面の情報をすぐ整理します。|小さな失敗の後でもっと簡単な方法を見つけます。|少し待つ間に次の選択を決めます。|慣れた人からうれしい知らせを聞きます。|午前に終えた小さなことが午後を楽にします。|短く言ったほうが意味が正確に伝わります。|面倒だったことを終えてチェックを付けます。|近い場所で探していた答えや物を見つけます。|助けを頼んできた人が後で役立つ情報をくれます。|予定外のことが思ったより早く終わります。|少し休む間にメモしたい考えが浮かびます。|知らない選択肢も値段や時間を比べて選びます。|午後遅くにうれしい通知や連絡が来ます。|思わぬほめ言葉で表情が明るくなります。|手に届くことから始めて周りを早く片づけます。|軽く送った言葉が短い会話につながります。|後回しにした連絡先をもう一度開きます。|ぼんやりした優先順位を三つに減らします。|小さな発見で買いたい物を選び直します。|静かに用意した持ち物が最後に役立ちます。|いつもと違う時間に集中しやすくなります。|小さな親切が思ったより早く返ってきます。|心配していたことが短い確認で終わります。|待っていた言葉が短い文字で届きます。|軽い変化一つで一日の予定が新しくなります。|もう一度確認して失敗を減らします。|長く悩んだことに決める基準ができます。|速さを落として仕上げをきれいにします。|一人で準備した強みが会話の中で出ます。|見過ごしたメッセージから大事な日付を見つけます。|慣れた場所で新しく貼られた案内に従います。|先に笑ってあいさつし、会話を始めやすくします。|短い確認で信頼を得ます。|今日選んだ色が写真や物の中で何度も目に入ります。|短い移動中にやることを整理します。|意外と気に入るメニューや物を見つけます。|言いにくかったことが自然に出ます。|周りの人が動く時間に合わせて動きます。|少し遅く始めても最後の確認まで終えます。|少し譲ったおかげでより楽な席ができます。|新しい情報が今日の選択を変える理由になります。|笑って流したことが夜の話題になります。|片づいた場所で必要な物をすぐ見つけます。|身近な人の言葉が今日の選択の基準になります。|一日の終わりに小さなごほうびのようなことがあります。|普段しない確認で失敗を避けます。|思ったより楽に会うことや電話を終えます。|急に浮かんだアイデアをすぐ使います。|短い散歩の後に次にやることが見えます。|良い知らせが短い言葉や小さな通知から始まります。|最後に選んだものが実際に楽です。|楽に選んだものに長く満足します。|少し勇気を出して先に話すと状況が変わります。';
  ...
  String get fortuneSajuNameElementExtras =>
      '小さな手がかりをつかむ型|ゆっくりでも正確な型|先に空気をほどく型|気分の回復が早い型|良い言葉を渡せる型|新しい流れを開く型|落ち着いて中心を取る型|短い確認に強い型|隠れた長所を見つける型|楽な選択が上手な型|関係の温度を合わせる型|最後の整理に強い型|小さな変化に明るい型|情報を早くつなぐ型|心を軽くする型|静かに進める型|興味を生かす型|基準を作る型|笑いどころを見つける型|感覚を信じる型|もう一度確認する型|親切を覚えている型|余白を作る型|偶然を拾う型|気分転換が早い型|正しい瞬間を選ぶ型|やわらかく説得する型|小さな達成を積む型|考えを簡単に整える型|状況を明るく見る型|待つ力がある型|身近な人を気にかける型|新しい好みを見つける型|淡々と終える型|一日のリズムを作る型|選択を軽くする型';

  @override
  String get fortuneSajuPlayAdvice =>
      '小さな偶然も見逃さないと一日がもっと楽しくなります。|先に片づけた人が今日の速度をつかめます。|軽く選んだものが思ったより長く気分を上げます。|言葉を減らすよりやさしく言う瞬間に力があります。|待っていた答えは思ったより単純な形で来そうです。|良い提案はすぐ断らず少しだけ開いておきましょう。|一日のどこかで自分に簡単な選択をあげてください。|今日は大きな変化より小さな方向転換が合います。|慣れた人の新しい一面を見られそうです。|何気ないことを一度だけ見直すとヒントが見えます。|少しの余裕が午後のミスを減らします。|軽く動くと頭の中の絡まりもほどけます。|気分が沈む時は鮮やかな色を近くに置いてみましょう。|知らない会話が思ったより早く楽になります。|急ぐ気持ちだけ減らせば結果は十分ついてきます。|短い確認をすると信頼が目に見えて積もります。|今日出会う情報の一つが後でかなり役に立ちます。|笑って流したことが夜には良い話題になります。|残すものと手放すものを分けると心が軽くなります。|新しく始めるより止まっていたことを再開するのに良い日です。|思いがけずほめられたらそのまま受け取って大丈夫です。|短い集中時間が長く運ぶ力になります。|ぎこちない瞬間は先に質問するとすぐほどけます。|今日の幸運は大きくではなく小さな繰り返しで来ます。|選択肢が多い時は一番楽なものを選びましょう。|微妙な勘が当たるかもしれないので記録しておくと良いです。|助けてもらったら感謝をすぐ残してみましょう。|早く終えられることは先に終えるほうが運を生かします。|好きな一文が一日の表情まで変えます。|待ったあとに来た知らせは少しゆっくり読んでも大丈夫です。|今日は整った始まりが整った終わりにつながります。|期待せずにしたことが小さな成果で戻りそうです。|誤解が生まれたら短くやわらかく確認するのが良いです。|自分の速度を守ると周りの流れも楽になります。|少しの沈黙がより良い答えを連れてきます。|最後に選んだものが今日の記憶になりそうです。';
  ...
  String get fortuneLuckyCueActions =>
      'もう一度確認する|先に笑ってみる|両手を軽く払う|最初の文を短く言う|感謝できることを一つ探す|短い呼吸で心をまとめる|速さより正確さを選ぶ|肩の力を抜く|相手の名前をやさしく呼ぶ|二つ目の選択を小さく変える|メモを一つ残す|歩みを少し遅くする|ミスの後すぐ整える|送る前に一度読む|助けを頼む人を思い浮かべる|確答の前に少し止まる|短いほめ言葉で雰囲気を上げる|最後の10分は軽く片づける|次のことを先に予想する|近くの色を一つ選ぶ|顔を上げてゆっくり見る|終えたらすぐ片づける|ぎこちなければ質問を一つする|今日良かった場面を覚える|静かな曲を一つ選ぶ|バッグの中を一度整える|水を一口飲む|心配を三行に減らす|気分の良い写真をもう一度見る|短い返事を先に送る|座る場所を少し変える|夜にほめ言葉を一つ残す';
  ...
  String get runningCoachUploadGuideBody =>
      '例の再生はオーバーレイを覚えるためだけに使います。アップロード結果は自分の動画フレームから判断します。';
  ...
  @override
  String get runningCoachSampleFrameGuideTitle => 'オーバーレイが示すもの';

  @override
  String get runningCoachSampleFrameGuideBody =>
      '例のランナー上に、姿勢、着地、腕のタイミング、フレームの見え方が表示されます。';
  ...
  @override
  String get runningCoachSampleReferenceTab => '例A';
  ...
  String get runningCoachSampleMistakeBody =>
      'このクリップは別のランナーと環境の例です。対になる比較ではなく、読み取り表示だけを確認してください。';
  ...
  String get runningCoachSampleReferenceArms =>
      '腕角度: コーチは各サンプルフレームで肩、肘、手首の位置を読みます。';

  @override
  String get runningCoachSampleReferenceFrame =>
      'フレーム品質: 使用可能フレームは固定のサンプルラベルではなく、見えている体の点で決まります。';
  ...
  String get runningCoachSampleAnalysisMethodBody =>
      '安定した横向きフレームをサンプリングし、見えている体の点を確認し、接地区間を推定して、各指標を信頼度付きで採点します。';
  ...
  String get runningCoachSampleProcessBody =>
      'オーバーレイはコーチが見る順序を示します。安定フレームを選び、見えている体の点を固定し、体の線をつなぎ、角度を測り、接地の根拠を確認します。';

  @override
  String get runningCoachSamplePhaseFrame => 'フレーム抽出';

  @override
  String get runningCoachSamplePhaseJoints => '体の点を探す';

  @override
  String get runningCoachSamplePhaseMuscles => '体の負荷を表示';

  @override
  String get runningCoachSamplePhaseSkeleton => '体の線を接続';

  @override
  String get runningCoachSamplePhaseAngles => '角度を測定';

  @override
  String get runningCoachSamplePhaseContactScore => '接地根拠を確認';
  ...
  @override
  String get runningCoachSampleMetricDetailStatusLabel => '読み取り';

  @override
  String get runningCoachSampleMetricDetailKeyPositionTitle => '重要な位置';

  @override
  String get runningCoachSampleMetricDetailReferenceTitle => '例Aの動き';

  @override
  String get runningCoachSampleMetricDetailReviewTitle => '例Bの動き';
  ...
  String get runningCoachSampleArmsDetailReference =>
      '例Aは肘をコンパクトに保ち、肋骨の近くで前後に振る様子を示します。';
  ...
  String get runningCoachSampleArmsDetailHowRead =>
      'アプリは肩、肘、手首の位置を結び、肘が開きすぎるフレームを示します。';
  ...
  String get runningCoachSampleLandingDetailReference =>
      '例Aは足が腰の線に近く着き、接地が前進につながる様子を示します。';
  ...
  String get runningCoachSampleBounceDetailGoodRange =>
      '上下動は上半身の高さ変化に関するコーチングガイド範囲と、このクリップの実測値を合わせて比較します。';

  @override
  String get runningCoachSampleBounceDetailKeyPosition =>
      'ストライド区間: 複数フレームで上半身の基準点の軌跡を比較します。';

  @override
  String get runningCoachSampleBounceDetailReference =>
      '例Aは上下動が小さく、エネルギーが前方に向く様子を示します。';
  ...
  String get runningCoachSampleBounceDetailHowRead =>
      'アプリは単一フレームの外れ値を抑えるため、上半身の高さ標本の中央80%を使います。跳躍高ではなく、コーチング用の推定値です。';
  ...
  @override
  String get runningCoachEvidenceTitle => '自分の動画の根拠';

  @override
  String get runningCoachEvidenceBody =>
      'このフレームは分析したクリップから取り出され、選択したコーチング重点を支えます。';

  @override
  String get runningCoachEvidenceDetailsTitle => '根拠と測定方法';

  @override
  String get runningCoachEvidenceInsufficientTitle => 'このクリップを撮り直してください';
  ...
  String get runningCoachEvidencePoseFrameOnly =>
      '分析した姿勢フレームを表示しています。この画面には動画ファイルが保存されていません。';
  ...
  @override
  String get runningCoachEvidencePreviousFrame => '前の根拠フレーム';
  ...
  @override
  String get runningCoachEvidencePause => '根拠動画を一時停止';

  @override
  String runningCoachEvidenceFrameCount(int current, int total) {
    return '根拠 $current/$total';
  }
  ...
  @override
  String get runningCoachGoalMotionTitle => '今の姿勢と次の動き';

  @override
  String get runningCoachGoalMotionBody => '左は今の姿勢、右は次に試す動きです。';

  @override
  String get runningCoachGoalMotionActualLabel => '今の姿勢';
  ...
  @override
  String get runningCoachEvidenceWhyMattersLabel => 'なぜ大切か';

  @override
  String get runningCoachEvidenceTryLabel => '試すこと';

  @override
  String get runningCoachEvidenceRetakeLabel => '撮り直し設定';

  @override
  String get runningCoachEvidenceRetakeBody =>
      '横から全身と両足が見えるように撮ります。数歩の間、スマートフォンを動かさないでください。';
  ...
  @override
  String get runningCoachEvidencePostureLabel => '姿勢フレーム';

  @override
  String get runningCoachEvidenceBounceLabel => '上下動フレーム';

  @override
  String get runningCoachEvidenceLandingLabel => '着地フレーム';

  @override
  String get runningCoachEvidenceKneeLabel => '膝フレーム';
  ...
  @override
  String get runningCoachUnsupportedPlatform => 'このデバイスではランニング動画分析を利用できません。';
  ...
  String get runningCoachWebAnalyzerUnavailable =>
      'ブラウザの動画アナライザーを開始できませんでした。ページを再読み込みして、もう一度試してください。';

  @override
  String get runningCoachWebVideoDecodeFailed =>
      'このブラウザでは選択した動画を読み取れませんでした。MP4 または MOV ファイルを試してください。';
  ...
  String get runningCoachAnalysisTimedOut =>
      '分析に時間がかかりすぎました。より短く鮮明な側面クリップを試してください。';
  ...
  @override
  String get runningCoachNextGoalRepeat => '次の3回は、これだけを意識してください。';
  ...
  @override
  String get runningCoachHistoryClearAllAction => 'すべて削除';

  @override
  String get runningCoachHistoryClearAllTitle => 'コーチング分析をすべて削除しますか？';
  ...
  String get runningCoachSaveVideoBody =>
      '初期値はオフです。分析を削除するまでこの端末にローカルコピーを残したい場合だけオンにしてください。';

  @override
  String get runningCoachVideoSaveFailedTitle => '動画を保存できませんでした';
  ...
  @override
  String get runningCoachGoodFormAction => '良いフォーム';

  @override
  String get runningCoachGoodFormScreenTitle => '良いランニングフォーム';

  @override
  String get runningCoachGoodFormIntroTitle => '初心者から経験者まで';
  ...
  String get runningCoachGoodFormTechniqueBody =>
      '赤はよくあるミス、青は推奨する動きです。モデルの体型ではなく、示された位置関係と方向を確認してください。';

  @override
  String get runningCoachGoodFormCommonLabel => 'よくあるミス';

  @override
  String get runningCoachGoodFormRecommendedLabel => '推奨する動き';

  @override
  String get runningCoachGoodFormBeginnerLabel => 'まずはこれだけ';

  @override
  String get runningCoachGoodFormExperiencedLabel => 'さらに詳しく';
  ...
  String get runningCoachGoodFormExperiencedBounce =>
      '1歩の最高点だけで判断せず、複数のストライドで腰の高さの変化と接地リズムが一定か確認します。';

  @override
  String get runningCoachGoodFormExperiencedFootStrike =>
      '着地時の足と腰の前後距離、すねの向き、左右で同じパターンが繰り返されているかを確認します。';

  @override
  String get runningCoachGoodFormExperiencedKnee =>
      '着地直後に膝が固まったり急に潰れたりせず、支持中になめらかに曲がって伸びるか確認します。';

  @override
  String get runningCoachGoodFormExperiencedArms =>
      '肩の力み、肘の曲がり、手が体の中央を横切るか、左右の腕振りに差がないかを確認します。';

  @override
  String runningCoachGoodFormIllustrationSemantics(String metric) {
    return '$metricのよくあるミスと推奨する動きを比較するイラスト';
  }

  @override
  String get runningCoachGoodFormGuideFootnoteTitle => 'このガイドの役割';

  @override
  String get runningCoachGoodFormGuideFootnoteBody =>
      '一つの完璧な形を押しつける画面ではありません。体格、ペース、環境でフォームは変わるため、分析結果では自分の動画の根拠を優先してください。';
  ...
  String get runningCoachInRangeWatchSummary =>
      '広いガイド範囲には入っていますが、『良い』と呼べるほど目標中心に近くはありません。';

  @override
  String get runningCoachInRangeWatchCue =>
      '大きなフォーム変更をする前に、リズムを楽に保ち、似たクリップを2〜3本比較してください。';

  @override
  String get runningCoachInRangeWatchDrill => 'ドリル: 楽に20 mを2本走り、もう一度測定します。';
  ...
  @override
  String get matchCompetitionListTitle => '大会状況';
  ...
  @override
  String get matchCompetitionEditorBasicsTitle => '大会基本';

  @override
  String get matchCompetitionEditorOperationsTitle => '運営情報';
  ...
  @override
  String get matchHubNoTeamsSubtitle => '選手登録から始められるチーム管理画面で自分のチームを準備しましょう。';
  ...
  @override
  String get matchHubMatchCommandHelper => '試合記録、記録確認、統計分析をすばやく実行します。';
  ...
  @override
  String get clubScheduleColorPresetsLabel => '代表色';
  ...
  @override
  String get teamManagementTacticBoardDeleteDialogTitle => '戦術を削除';

  @override
  String teamManagementTacticBoardDeleteDialogBody(Object title) {
    return '「$title」の戦術を削除しますか?';
  }

  @override
  String get teamManagementTacticBoardDeletedFeedback => '戦術を削除しました。';

  @override
  String get teamManagementTacticBoardUndoFeedback => '戦術の変更を取り消しました。';
  ...
  String get teamManagementSavedTeamsHelper =>
      '保存済みチームを選ぶと、選手名簿、戦術原則、ボード配置の運営を続けられます。';
  ...
  @override
  String get teamManagementOperationsTitle => '運営サマリー';
  ...
  @override
  String get teamManagementOperationsNextTrainingUnset => '練習予定なし';

  @override
  String get teamManagementOperationsRosterLabel => '選手名簿の状態';

  @override
  String teamManagementOperationsRosterValue(int total, int managed) {
    return '全$total人 · 管理$managed人';
  }

  @override
  String get teamManagementOperationsLineupLabel => 'ラインアップ';

  @override
  String get teamManagementOperationsCompetitionsLabel => '大会';

  @override
  String teamManagementOperationsCompetitionsValue(int active, int total) {
    return '進行$active · 全$total';
  }

  @override
  String get teamManagementOperationsScheduleTitle => '予定と大会';
  ...
  @override
  String get teamManagementOperationsNoTraining => '登録された練習予定はありません。';

  @override
  String get teamManagementOperationsUniformLabel => 'ユニフォーム';

  @override
  String get teamManagementOperationsCompetitionTitle => '参加大会';

  @override
  String get teamManagementOperationsNoCompetitions =>
      '大会管理でリーグやトーナメントを作成すると、ここに進行状況が表示されます。';
  ...
  String get teamManagementMatchSectionHelper =>
      '試合記録、記録確認、統計、クラブ予定を一か所から実行します。大会管理はタイトル右側の操作から開けます。';
  ...
  @override
  String get trainingSketchStageActionSelectedLabel => '選択中';

  @override
  String get trainingSketchInsertActionAfterTooltip => 'この動作の後に動作を挿入';
  ...
  @override
  String get trainingSketchTemplateBallMasteryLabel => 'ボールマスタリー・スラローム';

  @override
  String get trainingSketchTemplateBallMasteryDescription => 'ドリブル、方向転換、フィニッシュ';

  @override
  String get trainingSketchTemplateBallMasteryMethod =>
      'ボールを前に置き、各コーンで速度を変えてから目標へフィニッシュする';

  @override
  String get trainingSketchTemplateFirstTouchFinishLabel => 'ファーストタッチからフィニッシュ';
  ...
  String get trainingSketchTemplateFirstTouchFinishMethod =>
      'ハーフターンで受け、最初のタッチをスペースへ運んで早く仕留める';

  @override
  String get trainingSketchTemplateOneVOneLabel => '1対1の突破とフィニッシュ';

  @override
  String get trainingSketchTemplateOneVOneDescription => '緩急で守備者をかわす';

  @override
  String get trainingSketchTemplateOneVOneMethod =>
      '守備者を引きつけ、肩の外側へ加速して次のタッチでフィニッシュする';

  @override
  String get trainingSketchTemplateTwoVOneLabel => '2対1オーバーラップ・フィニッシュ';

  @override
  String get trainingSketchTemplateTwoVOneDescription => 'パス、オーバーラップ、再び受けて仕留める';

  @override
  String get trainingSketchTemplateTwoVOneMethod =>
      'パス中に動いて守備者を引きつけ、リターンパスからフィニッシュへ入る';

  @override
  String get trainingSketchTemplateThirdManLabel => '3人目のラン';

  @override
  String get trainingSketchTemplateThirdManDescription => 'パス、落とし、ライン背後へのラン';

  @override
  String get trainingSketchTemplateThirdManMethod =>
      'リンク役がワンタッチで落とし、3人目をスペースへ走らせる';
  ...
  String get trainingSketchTemplateCoordinationFinishDescription =>
      'ラダー、ハードル、ターン、ボールフィニッシュ';

  @override
  String get trainingSketchTemplateCoordinationFinishMethod =>
      'ラダーとハードルで姿勢を保ち、タイトにターンしてコントロールして仕留める';

  @override
  String get trainingSketchTemplateBaseballDoublePlayLabel => '併殺プレー連係';
  ...
  String get trainingSketchTemplateBaseballDoublePlayMethod =>
      'ゴロを確実に処理し、正確に送球して素早く一塁へつなぐ';

  @override
  String get trainingSketchTemplateBaseballBaseRunningLabel => '長打の走塁';
  ...
  String get trainingSketchTemplateBaseballBaseRunningMethod =>
      '強くスタートし、各ベースを安定して回り、中継プレーを見て次を判断する';

  @override
  String get trainingSketchTemplateBasketballTransitionLabel => '3レーン・トランジション';
  ...
  String get trainingSketchTemplateBasketballTransitionMethod =>
      '各レーンを埋め、プレッシャー前に前進パスを出して速く仕留める';

  @override
  String get trainingSketchTemplateBasketballPickRollLabel => 'ピック＆ロール・キックアウト';

  @override
  String get trainingSketchTemplateBasketballPickRollDescription =>
      'スクリーン、ドライブ、キックアウト、シュート';

  @override
  String get trainingSketchTemplateBasketballPickRollMethod =>
      'バランス良くスクリーンをかけ、ギャップを攻めてフリーのシューターを見つける';

  @override
  String get trainingSketchTemplateTennisReturnRecoverLabel => 'リターンとリカバリー';
  ...
  String get trainingSketchTemplateTennisReturnRecoverMethod =>
      'リターン位置へ入り、クロスへ送り、中央を経由して次の球に備える';

  @override
  String get trainingSketchTemplateTennisApproachVolleyLabel => 'アプローチ＆ボレー';
  ...
  String get trainingSketchTemplateTennisApproachVolleyMethod =>
      'スペースへアプローチを送り、バランス良く近づいて前へボレーする';
  ...
  @override
  String get runningCoachDefaultRunner => '自分';
  ...
  @override
  String get runningCoachManageRunners => 'ランナー管理';

  @override
  String get runningCoachSelectRunnerTitle => '誰を分析しますか？';

  @override
  String get runningCoachAddRunner => 'ランナーを追加';

  @override
  String get runningCoachRenameRunner => '名前を変更';

  @override
  String get runningCoachArchiveRunner => 'アーカイブ';

  @override
  String get runningCoachRunnerNameLabel => 'ランナー名';

  @override
  String get runningCoachManageRunner => 'ランナー管理';
  ...
  String get runningCoachCaptureWarningAnalysisLimited =>
      'そのまま撮影できますが、構図が不明瞭だと分析が推定または制限される場合があります。';

  @override
  String get runningCoachPreviewCheckFullBody => '全身';

  @override
  String get runningCoachPreviewCheckSide => '側面';

  @override
  String get runningCoachPreviewCheckClarity => '鮮明な距離';

  @override
  String get runningCoachTodayOneThingTitle => '今日はこれだけ変えましょう';

  @override
  String get runningCoachStatusEstimatedShort => '推定';

  @override
  String get runningCoachViewEvidenceSlowly => '根拠をスローで見る';
  ...
  @override
  String get runningCoachStatusUnavailableShort => '測定不可';

  @override
  String get runningCoachFullAnalysisAction => '分析全体を見る';

  @override
  String get runningCoachGoodBandLabel => '良好な範囲';

  @override
  String get runningCoachNextCueLabel => '次のキュー';

  @override
  String get runningCoachRawMeasurementDetails => '測定値の詳細を見る';

  @override
  String get runningCoachConfidenceShortLabel => '信頼度';

  @override
  String get runningCoachMeasurementMethodLabel => '測定方法';

  @override
  String get runningCoachGaitRhythmTitle => 'リズムとタイミング';

  @override
  String get runningCoachReportDetailsTitle => '動きの詳細';

  @override
  String get runningCoachGaitFineTitle => '歩容の詳細';

  @override
  String get runningCoachTodayLabel => '今日';

  @override
  String get runningCoachAnalysisQualityBadgeStrong => '安定した分析';

  @override
  String get runningCoachAnalysisQualityBadgeLimited => '制限付き分析';
  ...
  @override
  String get runningCoachHistoryScoreUnavailable => 'スコア保留';

  @override
  String get runningCoachMultiplePersonLabel => '複数人を検出';

  @override
  String get runningCoachTargetIdentityUnstableLabel => 'ランナー追跡の変化';

  @override
  String get runningCoachMultiplePersonReason =>
      '動画に複数人がいる可能性があるため、別の人を採点しないようスコアを保留しました。';

  @override
  String get runningCoachTargetIdentityUnstableReason =>
      'ランナー追跡が急に変化したため、別人の記録を混ぜないようスコアを保留しました。';

  @override
  String get runningCoachSingleRunnerRetake => '一度に1人だけを撮影し、ほかの人は画面の外にしてください。';
