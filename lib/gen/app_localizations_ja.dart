...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get fortuneDailyOutcomeTimes =>
      '朝の最初の通知で|出かける途中で|昼前に|昼食後の短い休憩で|午後の移動中に|慣れた場所で|メッセージを確認する時に|片づけている時に|待っている間に|一日を終える頃に';

  @override
  String get fortuneDailyOutcomeSubjects =>
      'うれしい知らせが|後回しの用事が|必要だった情報が|短い会話が|小さなほめ言葉が|忘れていた予定が|思わぬ空き時間が|楽な選択肢が|新しい手がかりが|待っていた答えが';

  @override
  String get fortuneDailyOutcomeResults =>
      '一日を軽くしてくれます。|気持ちを少し楽にします。|次の選択を簡単にします。|気分が上向く方へつながります。|小さなごほうびのように残ります。|残りの予定を楽に開きます。|迷っていた気持ちを整えます。|短い笑いに広がります。|一日の終わりに満足として戻ります。|必要な方へ自然につながります。';
