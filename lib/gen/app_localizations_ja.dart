...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get fortuneMyeongliTenGodDailyLines =>
      '朝に今日やることを三つに分けやすい日なので|グループの連絡で必要な言葉だけ選びやすい日なので|小さなおやつや休憩で気分を戻しやすい日なので|いつもと違う言い方でも伝わりやすい日なので|急に来た提案をすぐ比べやすい日なので|かばんや机の上を片づけやすい日なので|返事を長く迷わず早めに選びやすい日なので|約束の時間と順番を守りやすい日なので|見逃した通知をもう一度確認しやすい日なので|助けを頼んでも気まずくなりにくい日なので';

  @override
  String get fortuneMyeongliTwelveStageDailyLines =>
      '朝の最初の行動を小さく始めやすい日なので|表情や声の変化に早く気づきやすい日なので|席や持ち物を先に整えやすい日なので|自分の速さで一つずつ進めやすい日なので|午前中にたまったことを始めやすい日なので|いらない予定や物を減らしやすい日なので|無理な予定より休憩を先に入れやすい日なので|終えることを一つ選んで片づけやすい日なので|前に書いたメモから答えを見つけやすい日なので|やめることと続けることを分けやすい日なので|新しく試すことを小さく決めやすい日なので|明日やることを今夜メモしやすい日なので';

  @override
  String get fortuneMyeongliBranchRelationDailyLines =>
      '身近な人と一緒にやると早く終わりやすい日なので|意見がぶつかっても次にやることが見えやすい日なので|絡んだことを順番に書くとほどけやすい日なので|誤解があってもすぐ聞けば小さくしやすい日なので|乱れた約束をもう一度確認しやすい日なので|あちこちの話を一か所にまとめやすい日なので|慣れた場所でやることが見えやすい日なので';

  @override
  String get fortuneSajuElementFlows =>
      'ゆっくり始めても午前中に速さが出やすい日なので|うれしい名前からの連絡を確認しやすい日なので|なくした物や必要な情報を見つけやすい日なので|部屋や机の一か所を片づけやすい日なので|好きな音楽やおやつで気分が上がりやすい日なので|二つの選択肢から一つを選びやすい日なので|身近な人に先に話しかけやすい日なので|短い時間で一つのことに集中しやすい日なので|助けを受けると早く終わりやすい日なので|少し休んで再開すると良くなりやすい日なので|思いついたことをすぐメモしやすい日なので|いつもの場所で必要な手がかりを見つけやすい日なので|たまった通知やメモを消しやすい日なので|相手の表情を見て言葉を選びやすい日なので|約束の時間より10分早く動きやすい日なので|少し勇気を出して先に話しやすい日なので|待っていた知らせをもう一度確認しやすい日なので|楽な速さで最後までやりやすい日なので|止まったことを小さな手順に分けやすい日なので|自分で決めた順番で動きやすい日なので|先に笑ってあいさつすると話しやすい日なので|変わった予定や場所を早く確認しやすい日なので|待っていた答えをもう一度確認しやすい日なので|静かに準備したことを見せやすい日なので';

  @override
  String get fortuneSajuElementFlowExtras =>
      '相手の話を最後まで聞きやすい日なので|予想と違うことが起きても選び直しやすい日なので|負担の少ないことから始めやすい日なので|一人で決める前に一度聞きやすい日なので|小さな親切にすぐ気づきやすい日なので|メニューや道順を早く選びやすい日なので|終わったことにチェックを付けやすい日なので|気に入ったほうを5分だけ試しやすい日なので|遅れていた返事が届きやすい日なので|やることの答えを一行で書きやすい日なので|たまたま見た言葉や写真からヒントを得やすい日なので|物を元の場所に戻すと動きやすい日なので|新しく気になる物や話題を見つけやすい日なので|考えを紙に書くと軽くなりやすい日なので|問題の最初の手がかりを早く見つけやすい日なので|短く言っても意味が通じやすい日なので|やわらかく頼むと返事をもらいやすい日なので|小さなほめ言葉を聞いたり渡したりしやすい日なので|5分ほど休むと次のことが進みやすい日なので|約束の時間と移動時間が合いやすい日なので|通知を減らすと集中が続きやすい日なので|小さな失敗をすぐ直して進みやすい日なので|見落とした物や情報を見つけやすい日なので|午後からやることに速さが出やすい日なので|静かに準備した内容を認められやすい日なので|最初の感じより確認した内容を信じやすい日なので|予定を少し変えても自然に進みやすい日なので|先にあいさつすると反応をもらいやすい日なので|始めることを小さく決めやすい日なので|終える前にもう一度確認しやすい日なので|待つ時間が思ったより短く感じやすい日なので|もう一度笑えることが起きやすい日なので|新しい提案を断る前に聞きやすい日なので|固い言葉より楽な言葉が伝わりやすい日なので|正確に見てすぐ言うことが大事な日なので|気になることを調べたり聞いたりしやすい日なので';

  @override
  String get fortuneSajuFortuneThemes =>
      '朝の通知でうれしい名前を見られそうです。|昼前に後回しにしたメッセージを送れそうです。|待っていた返事が午後までに届きそうです。|初めて見る提案も条件をすぐ比べられそうです。|小さな買い物を減らして必要な物を選べそうです。|複雑だった考えをメモ一行にまとめられそうです。|身近な人と短く話して気持ちが楽になりそうです。|いつもの道で必要な案内や標識を見つけられそうです。|午後に後回しにしたことを20分ほど集中して終えられそうです。|誰かの短い言葉が今日の選択を助けてくれそうです。|予定が変わって、より楽な時間ができそうです。|忘れていた約束や持ち物を思い出せそうです。|片づけながら探していた物を見つけられそうです。|今日選んだ色や物で気分を切り替えられそうです。|待つ時間が減って次のことを早く始められそうです。|小さなほめ言葉を受け取ったり先に渡したりできそうです。|必要な情報が会話や通知で入ってきそうです。|一人の時間に後回しのことを静かに片づけられそうです。|短い散歩や移動中に解決方法が浮かびそうです。|迷っていた選択を夕方前に決められそうです。|言われなくても相手が求めていることに気づけそうです。|小さな失敗をすぐ直して笑って流せそうです。|相手の反応を早く見て言葉を変えられそうです。|長く後回しにした連絡を今日もう一度開けそうです。|新しく知った情報で選ぼうとしていたものを変えられそうです。|水一杯や短い休憩で気分が早く戻りそうです。|お金より時間を節約する選択をしそうです。|偶然会った人が次の約束につながりそうです。|静かに集中したことが見える結果として残りそうです。|気になっていたことが思ったより簡単に終わりそうです。|夜にもう一度確認すると見落とした部分を見つけられそうです。|誰かの頼みを片づけながら役立つ情報を得られそうです。|待っていた物や知らせを確認できそうです。|思ったより話しやすい人に会えそうです。|小さな片づけ一つで残りの予定が楽になりそうです。|最初に選んだものをそのまま続けても大丈夫そうです。';

  @override
  String get fortuneSajuFortuneThemeExtras =>
      '朝の最初の画面で必要な予定を確認できそうです。|小さな頼みごとを終えてすぐありがとうと言われそうです。|後回しにした片づけを10分以内に始められそうです。|気になっていた会話を短くもう一度出せそうです。|思ったより早く空き時間ができそうです。|軽く選んだ道で探していた店や場所を見つけられそうです。|先に動くと待つ時間を減らせそうです。|開いていた画面で探していた情報をすぐ見つけられそうです。|小さな失敗の後でもっと簡単な方法を見つけられそうです。|少し待つ間に次の選択を決められそうです。|慣れた人からうれしい知らせを聞けそうです。|午前に終えた小さなことが午後を楽にしてくれそうです。|短く言ったほうが意味が正確に伝わりそうです。|面倒だったことを終えてチェックを付けられそうです。|近い場所で探していた答えや物を見つけられそうです。|助けを頼んできた人が後で役立つ情報をくれそうです。|予定外のことが思ったより早く終わりそうです。|少し休む間にメモしたい考えが浮かびそうです。|知らない選択肢も値段や時間を比べれば選びやすそうです。|午後遅くにうれしい通知や連絡が来そうです。|思わぬほめ言葉で表情が明るくなりそうです。|手に届くことから始めて周りが早く片づきそうです。|軽く送った言葉が短い会話につながりそうです。|後回しにした連絡先をもう一度開けそうです。|ぼんやりした優先順位を三つに減らせそうです。|小さな発見で買いたい物を選び直せそうです。|静かに用意した持ち物が最後に役立ちそうです。|いつもと違う時間に集中しやすそうです。|小さな親切が思ったより早く返ってきそうです。|心配していたことが短い確認で終わりそうです。|待っていた言葉が短い文字で届きそうです。|軽い変化一つで一日の予定が新しくなりそうです。|もう一度確認して失敗を減らせそうです。|長く悩んだことに決める基準ができそうです。|速さを落とすと仕上げがきれいになりそうです。|一人で準備した強みが会話の中で出せそうです。|見過ごしたメッセージから大事な日付を見つけられそうです。|慣れた場所で新しく貼られた案内を見つけられそうです。|先に笑ってあいさつし、会話を始めやすくできそうです。|小さな約束を守って信頼を得られそうです。|今日選んだ色が写真や物の中で何度も目に入りそうです。|短い移動中にやることを整理できそうです。|意外と気に入るメニューや物を見つけられそうです。|言いにくかったことが自然に出せそうです。|周りの人が動く時間に合わせて動けそうです。|少し遅く始めても最後の確認まで終えられそうです。|少し譲ったおかげでより楽な席ができそうです。|新しい情報が今日の選択を変える理由になりそうです。|笑って流したことが夜の話題になりそうです。|片づいた場所で必要な物をすぐ見つけられそうです。|身近な人の言葉が今日の選択の基準になりそうです。|一日の終わりに小さなごほうびのようなことがありそうです。|普段しない確認で失敗を避けられそうです。|思ったより楽に会うことや電話を終えられそうです。|急に浮かんだアイデアをすぐ使えそうです。|気持ちが混んでいたら、短い散歩の後にやることが見えそうです。|良い知らせが短い言葉や小さな通知から始まりそうです。|最後に選んだものが実際に楽そうです。|楽に選んだものに長く満足できそうです。|少し勇気を出して先に話すと状況が変わりそうです。';
