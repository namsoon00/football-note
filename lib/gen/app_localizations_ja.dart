...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get fortuneMyeongliTenGodDailyLines =>
      '自分の基準がはっきりしやすい流れなので|周りの速さと距離を取りやすい流れなので|小さな楽しみが気分をほぐす流れなので|表現が少し新しくなる流れなので|思わぬ提案を受け取りやすい流れなので|整えるべきことが見えやすい流れなので|判断が早くなる流れなので|約束と順番が整う流れなので|見慣れないヒントが目に入りやすい流れなので|助けを気楽に受け取りやすい流れなので';

  @override
  String get fortuneMyeongliTwelveStageDailyLines =>
      '新しい気が小さく上がる流れなので|感覚が鋭くなりやすい流れなので|姿勢を整えやすい流れなので|自分のペースが見えやすい流れなので|推進力が強まる流れなので|余分な力を抜きやすい流れなので|コンディションを先に見やすい流れなので|終えることを選びやすい流れなので|寝かせた考えが浮かびやすい流れなので|切るべきことを短く整える流れなので|小さな可能性が見えやすい流れなので|次の流れを静かに育てやすい日なので';

  @override
  String get fortuneMyeongliBranchRelationDailyLines =>
      '近い協力が生きる流れなので|ぶつかった後に方向がはっきりする流れなので|絡んだことが順番にほどける流れなので|小さな誤解を確かめやすい流れなので|乱れた約束を整えやすい流れなので|散った気が一か所に集まる流れなので|慣れた場所で安定感が増す流れなので';

  @override
  String get fortuneSajuElementFlows =>
      'ゆっくり始めやすい流れなので|うれしい連絡を期待しやすい流れなので|小さな幸運が目に入りやすい流れなので|気持ちを整えやすい流れなので|軽いときめきが続く流れなので|選択がはっきりしやすい流れなので|あたたかい出会いが開く流れなので|気持ちよく集中しやすい流れなので|思わぬ助けを受け取りやすい流れなので|落ち着いて回復しやすい流れなので|新しいアイデアが浮かぶ流れなので|隠れたチャンスが見える流れなので|整えるほど気持ちが軽くなる流れなので|早い気づきが必要な流れなので|やわらかなタイミングが生きる流れなので|小さな勇気を出しやすい流れなので|良い知らせの気配が見える流れなので|心地よい速さが合う流れなので|詰まったことがほどける流れなので|自分のリズムを信じやすい流れなので|先に笑うと空気がほぐれる流れなので|小さな変化が目に入る流れなので|待っていた答えが近づく流れなので|静かな自信が戻る流れなので';

  @override
  String get fortuneSajuElementFlowExtras =>
      '落ち着いて観察しやすい流れなので|軽い反転が起こりやすい流れなので|気楽な挑戦が合う流れなので|気持ちが少し広がる流れなので|思わぬ親切に会いやすい流れなので|選びやすくなる流れなので|小さな達成感が積もる流れなので|良い予感が生きる流れなので|ゆっくりした幸運が近づく流れなので|はっきりした答えが浮かぶ流れなので|きらっとした偶然が見える流れなので|周りを整えるほど運が軽くなる流れなので|新しい関心が生まれる流れなので|心が軽くほどける流れなので|手がかりが早めに見える流れなので|言葉が通じやすい流れなので|心地よい勇気を出しやすい流れなので|小さな評価を受け取りやすい流れなので|ひと息つく余裕が必要な流れなので|タイミングが合いやすい流れなので|集中が深まりやすい流れなので|小さな失敗も笑って流しやすい流れなので|うれしい発見が生まれる流れなので|一日に速さがつく流れなので|静かな自信が生きる流れなので|勘が冴えやすい流れなので|方向転換が自然な流れなので|小さな人気が出やすい流れなので|感じの良い始まりができる流れなので|さっぱり終えやすい流れなので|待つ時間が短くなる流れなので|もう一度笑えることが起こりやすい流れなので|良さそうな提案を開いておきたい流れなので|心がやわらかくほどける流れなので|正確な勘が必要な流れなので|あたたかい好奇心が続く流れなので';
